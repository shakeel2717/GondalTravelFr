...
if ($payload->type == "invoice") {
    ...
    $success = root.$payload->booking_module."/invoice/update?booking_id=".$booking_id."&booking_no=".$booking_no."&supplier_name=".$supplier_name."&booking_status=confirmed&payment_status=paid&payment_date=".date('Y-m-d')."&txn_id=0&token=0&logs=&desc=0&payment_gateway=".$gateway."&amount_paid=".$price."remaining_amount=0";
